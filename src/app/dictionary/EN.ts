...
export class Dictionary implements DictionaryInterface {
    ...
    importDescription = "Import file from APP_DATA folder"
    export = "Export settings"
    exportDescription = "Export file in APP_DATA folder"
    reset = "Reset settings"
    resetDescription = "Reset all settings, useful if app breaks"
    resetPrompt = "Are you sure you want to reset all settings?"
    ...
    importPrompt = "Are you sure you want to import setting from {{appDir}}/files/lastpressed/settings.json? This will overwrite your current settings."
